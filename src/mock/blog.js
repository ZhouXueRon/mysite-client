...
Mock.mock(/^\/api\/blog(\?.+)?$/, 'get', function (options) {
    const paramStr = options.url.split('?')[1];
    const query = qs.parse(paramStr);
    return Mock.mock({
        code: 0,
        msg: "",
        data: {
            ...
            [`rows|${query.limit || 10}`]: [{
                ...
                "scanNumber|0-3000": 0,
                "commentNumber|0-3000": 0,
                "thumb|1": [`https://picsum.photos/300/250?@guid`, null],
    ...
    return Mock.mock({
        ...
        data: {
            ...
            [`rows|${query.limit || 10}`]: [{
                ...
                content: "@cparagraph(1, 10)",
                createDate: Date.now(),
                avatar: `https://picsum.photos/300/250?@guid`,
            }]
        }
    })
})